            ...
            productosDisponibles.forEach((producto, index) => {
                ...
                productRow.innerHTML = `
                    ...
                    <div class="form-group" style="margin: 0;">
                        ...
                        <input type="number" id="cantidad-${index}" min="0" value="0" onchange="calcularTotal()" style="padding: 8px;">
                    </div>
                    <div class="form-group" style="margin: 0;">
                        <label>Subtotal:</label>
                        <p id="subtotal-${index}" style="font-weight: bold; color: var(--color-principal); margin-top: 8px;">$0.00</p>
                    </div>
                `;
